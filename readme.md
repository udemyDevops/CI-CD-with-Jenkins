...
1. [_Basics in Jenkins_](Basics)
2. [_CI piepline flow and pipeline code_](CI-pipeline)
...
4. [_Build Triggers_](Build-triggers)
...
5. [_Agent/Node/Slave concept_](Agent-Node-Slave)
6. [_Jenkins security_](Jenkins-security)
